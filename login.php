<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])){
        ...
        $specificQueryFour = $db->query("SELECT * FROM SIGNUP");
        $serviceResultFour = $specificQueryFour->fetchAll(PDO::FETCH_ASSOC);
        
        $lastnametoremember = "";

        for($i = 0; $i < sizeof($serviceResultFour); $i++){
            if($serviceResultFour[$i]["username"] == $userid){
                $lastnametoremember = $serviceResultFour[$i]["last_name"];
            }
        }        
        $_SESSION["transfer_last_name"] = $lastnametoremember;
        ...
        <div class="row">
            ...
            <div class="col-6">
                <form action="" method="POST">
                    <input name="username" placeholder=" Username:" type="text" style="width: 200px; margin-bottom: 5%; margin-top: 10%; border-radius: 10px !important; width: 250px; height: 40px;" value="<?php echo $userid; ?>" required>

                    <br>

                    <input name="password" placeholder=" Password:" type="text" style="width: 200px; margin-bottom: 3%; border-radius: 10px !important; width: 250px; height: 40px;" value="<?php echo $password; ?>" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <br>
                            <a style="color: black;" href="signupprototype.php">Need to Sign Up</a>
                        </div>
                        <div class="col-1"></div>
                    </div>
                </form>
